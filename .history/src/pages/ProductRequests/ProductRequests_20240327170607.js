          ...
          <div className="request-div ">
            <div className="transaction-page">
              ...
              <div className="panels">
                <div className={`panel ${checkActive(1, "prd-active")}`}>
                  {filteredProducts.map((data, index) => (
                    <Requests data={data} />
                  ))}
                </div>
                <div className={`panel ${checkActive(2, "prd-active")}`}>2</div>
                <div className={`panel ${checkActive(3, "prd-active")}`}>3</div>
                <div className={`panel ${checkActive(4, "prd-active")}`}>4</div>
              </div>
            </div>
          </div>
        </div>
