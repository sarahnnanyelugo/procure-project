...
import Icon from "../../assets/images/form-icon1.svg";
import Icon2 from "../../assets/images/no-job.png";
    ...
    <>
      ...
      <div className="prerks-div">
        ...
        <div className="flexy">
          ...
          <div className="col-md-2 green-bg dn" />
        </div>
        <center>
          <button className="app-btn">View open roles</button>
        </center>
      </div>
      <div className="col-md-10 offset-md-1 mt grey-divv">
        <h2>Who we hire</h2>
        <p>
          We’re looking for those who wants to grow and standout in their
          career.
        </p>
        <div className=" row row-cols-1 row-cols-lg-3 g-2  g-lg-5 no-m mt4">
          <div className="col">
          ...
          <div className="col">
            <div className="perks2">
              ...
              <h5>Resilience</h5>
              <p>
                Our goal is to make ProCURED a 100-year company by creating
                products that are built to last, and that means working at a
                relentless pace. To negotiate ambiguity and thrive on change
                rather than tolerate it, you must possess resilience.
              </p>
            </div>
          </div>{" "}
          <div className="col">
            <div className="perks2">
              ...
              <p>
                The capacity to analyze information objectively, evaluate
                options, and make well-informed decisions. Critical thinkers can
                assess situations from various perspectives and consider the
      ...
      <center>
        <div className="col-md-4 role">
          <h2>Find the role for you</h2>
          <p>Choose any of our roles that fits your career</p>
          <img src={Icon2} width="100%" />
          <p className="col-md-8 mt6">
            There are no open positions right now. Kindly check back later
          </p>
        </div>
      </center>
