  ...
  return (
    <>
      ...
      <div className="prerks-div">
        ...
        <div className="col-md-8 offset-md-2 row row-cols-1 row-cols-lg-2 g-2 mt4 g-lg-3">
          {" "}
          <div className="col">
            <div className="perks">
              <h5>Continuous Learning Opportunities</h5>
              <p>
          ...
          <div className="col">
            <div className="perks">
              <h5>Competitive Compensation Packages</h5>
              <p>
                We offer competitive salary and benefits packages to attract and
                retain top talent. This can include performance bonuses, stock
                options, and other incentives that contribute to overall job
                satisfaction.
              </p>
            </div>
          </div>
