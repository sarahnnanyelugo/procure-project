  ...
  return (
    <>
      ...
      <div className="prerks-div">
        ...
        <div className="col-md-10 offset-md-1 mt5 grey-divv">
          <h2>Who we hire</h2>
          <p>
            ...
            <div className="col">
              <div clasName="perks2">
                ...
                <p>
                  ...
                  options, and make well-informed decisions. Critical thinkers
                  can assess situations from various perspectives and consider
