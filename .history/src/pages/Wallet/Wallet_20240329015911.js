    ...
    <>
      ...
      <div className="transact-history mt3">
        ...
        <div className="wallet-table">
          {" "}
          <div className="filtering-btns2">
            <button
              className={`btn prd-actived ${category === "*" ? "actived" : ""}`}
              onClick={() => setCat("*")}
            >
              All
            </button>
            <button
              className={`btn ${category === "pending" ? "actived" : ""}`}
              onClick={() => setCat("pending")}
            >
              Pending
            </button>
            <button
              className={`btn ${category === "completed" ? "actived" : ""}`}
              onClick={() => setCat("completed")}
            >
              Completed
            </button>{" "}
            <button
              className={`btn ${category === "cancelled" ? "actived" : ""}`}
