  ...
  return (
    <>
      <div id="cover verified-div">
        <img className="vid" width="100%" src={Banner}></img>
      ...
      <div className="col-md-10 offset-md-1 flexy mobile-padding">
        <div className="col-md-6">
          {" "}
          <img className="col-md-12" src={Img4} width="100%" />
        </div>
        <div className="col-md-5 offset-md-1 front-line-list">
          <div className="flexy flexyM mt4">
            <div className="circle col-md-1 col-1" />
            <div>
          ...
          <div className="flexy flexyM mt4">
            ...
            <div>
              ...
              <p>
                Receive personalized assistance to optimize your store,
                troubleshoot issues, and enhance your overall selling
                experience.
              </p>
            </div>
          </div>{" "}
          <div className="flexy flexyM mt4">
            ...
            <div>
              ...
              <p>
                Utilize data-driven insights to make informed decisions, refine
                your marketing strategy, and enhance your product offerings.
              </p>
            </div>
          </div>
          <button className="app-btn mt4">View open roles</button>
        </div>
      </div>
      <div className="how-to-apply ">
        <center>
          <div className="col-md-5">
            <h1>How to apply</h1>
            <p>
              Joining our verified seller program is easy! Simply follow these
              steps:
            </p>
          </div>
        </center>
        <div className="flexy col-md-10 offset-md-1 mt6 no-m">
          <div className="col-md-3 apply-steps">
            <h1>1</h1>
            <p>Create an account on ProCURED</p>
          </div>
          <div className="col-md-3 apply-steps">
            <h1>2</h1>
            <p>Complete the seller verification application</p>
          </div>
          <div className="col-md-3 apply-steps">
            <h1>3</h1>
            <p>Provide necessary documentation to validate your business</p>
          </div>
          <div className="col-md-3 apply-steps">
            <h1>4</h1>
            <p>Await approval from our team</p>
          </div>
        </div>
      </div>
