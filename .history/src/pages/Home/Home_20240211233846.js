  ...
  return (
    <>
      <div id="cover">
        ...
        <div className=" col-md-12 overlay">
          ...
          <div className="col-md-6 offset-md-1 mt6 input-div mobile-padding">
            ...
            <div
              className="input-overlay flexy flexyM col-md-12 col-12"
            ...
            >
              ...
              <div className="flexy flexyM offset-md-6 offset-5 ">
                <img
                  src={Audio}
                  height="24px"
                  width="24px"
                ...
                <img
                  ...
                  className="input-actions "
                />
                <button className="app-btn col-7  ">Sign up</button>
              </div>
            </div>
          </div>
      ...
      <div className="col-md-10 offset-md-1 brands">
        ...
        <div className="row row-cols-2 row-cols-lg-4 g-2 g-lg-3 mt8">
          <div className="col">
