        ...
        <div className="col-md-11">
          ...
          <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              <Accordion.Header onMouseEnter={() => displayImageImage()}>
              ...
              <Accordion.Body>
                ...
                <div className="flexy col-md-12">
                  <ul className="list-unstyled col-md-6">
                    <li> Track attendance with ease</li>{" "}
                    <li> Convert time to timesheets</li>
                  </ul>{" "}
                  <ul className="list-unstyled col-md-6">
                    <li> Schedule shifts effortlessly</li>{" "}
                    <li> Track days off efficiently</li>
                  </ul>
                </div>
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="1">
              <Accordion.Header onMouseEnter={() => displayImageImage2()}>
              ...
              <Accordion.Body>
                ...
                <ul className="list-unstyled col-md-">
                  <li> Continuous reviews and performance appraisals</li>{" "}
                  <li> Analytics to identify performance gaps</li>{" "}
                  <li> 360-degree feedback</li>
                </ul>{" "}
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="2">
              <Accordion.Header onMouseEnter={() => displayImageImage3()}>
              ...
              <Accordion.Body>
                ...
                <ul className="list-unstyled col-md-">
                  ...
                  <li> Blended learning with virtual classrooms</li>{" "}
                  <li> Centralized course management</li>
                </ul>{" "}
              </Accordion.Body>
            </Accordion.Item>{" "}
            <Accordion.Item eventKey="3">
              <Accordion.Header onMouseEnter={() => displayImageImage4()}>
                <h3>Empower Learning, Inspire Growth</h3>
              </Accordion.Header>
              <Accordion.Body>
                <p>
