...
const Features = () => {
  ...
  return (
    <div className="features-container flexy col-md-12 ">
      <h1>
        Streamline from search to fulfillment with an all-in-one platform.
      </h1>
      <div className="col-md-5">
        <div className="col-md-11">
          ...
          >
            ...
            <p>
              Specify quantities, explore customization options, and add chosen
              items to your bulk cart.
            </p>
          </div>
          <div
