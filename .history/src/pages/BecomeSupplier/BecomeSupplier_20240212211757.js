...
import Img11 from "../../assets/images/call-center.png";
import Img12 from "../../assets/images/shipping.png";
  ...
  return (
    <>
      ...
      <div className="col-md-10 offset-md-1 mt8">
        ...
        <div className="row row-cols-2 row-cols-lg-4 g-2 g-lg-3 mt2 mobile-padding ">
          <div className="col">
