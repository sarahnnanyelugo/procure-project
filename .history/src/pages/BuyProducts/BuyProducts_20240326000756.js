  ...
  return (
    <>
      ...
      <div className="col-md-5 offset-md-3 flexy first-product-row">
        ...
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon5} name="Construction & Real Estate" />
        </div>{" "}
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon1} name="Vehicle Accessories, …" />
        </div>{" "}
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon1} name="School & Office Supplies" />
        </div>
      </div>
      <div className="col-md-6 offset-md-3 flexy first-product-row sec-row">
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon1} name="Construction" />
        </div>{" "}
        <div className="area-div">
          {" "}
