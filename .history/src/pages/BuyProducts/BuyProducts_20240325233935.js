...
export const BuyProducts = () => {
  return (
    <>
      ...
      <div className="col-md-6 offset-md-3 flexy first-product-row">
      ...
      <div className="col-md-5 offset-md-4 flexy first-product-row">
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon1} name="Lights & Lighting" />
        </div>{" "}
      ...
      <div className="col-md-4 offset-md-5 flexy first-product-row">
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon1} name="Lights & Lighting" />
        </div>{" "}
      ...
      <div className="col-md-3 offset-md-6 flexy first-product-row">
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon1} name="Lights & Lighting" />
        </div>{" "}
