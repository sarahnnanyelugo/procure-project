...
export const BuyProducts = () => {
  return (
    <>
      ...
      <div className="col-md-5 offset-md-3 flexy first-product-row mt6">
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon4} name="Lights & Lighting" />
        </div>{" "}
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon8} name="Home Appliances" />
        </div>{" "}
        <div className="area-div">
          {" "}
        ...
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon5} name="Vehicle Accessories, …" />
        </div>{" "}
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon9} name="School & Office Supplies" />
        </div>
      </div>
      <div className="col-md-6 offset-md-3 flexy first-product-row sec-row">
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon12} name="Construction" />
        </div>{" "}
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon6} name="Beauty" />
        </div>{" "}
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon10} name="Furniture" />
        </div>{" "}
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon13} name="Mother, Kids & Toys" />
        </div>{" "}
      </div>{" "}
      <div className="col-md-4 offset-md-4 flexy first-product-row third-row">
        ...
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon7} name="Jewelry, Eyewear, …." />
        </div>{" "}
      </div>{" "}
      <div className="col-md-2 offset-md-5 flexy first-product-row fourth-row">
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon11} name="Sports & Entertainment" />
        </div>{" "}
        <div className="area-div">
          {" "}
          <ProductAreas Icon={Icon14} name="Shoes & Accessories" />
        </div>{" "}
      </div>
      <Link to={"/"}>
        <button className="app-btn offset-md-11">Next</button>
      </Link>
