  ...
  return (
    <>
      ...
      <div className="about-banner">
        ...
        <hr />
        <div className="col-md-10 flexy nd-paragrapgh offset-md-1 mt7">
          ...
          <div className="mt4">
            <p>
              ...
              Founded in 2024 by Anderson Warri, ProCURED ecommerce platform has
              helped both sellers and buyers around the world, now with an
