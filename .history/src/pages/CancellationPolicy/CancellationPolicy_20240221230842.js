  ...
  return (
    <>
      ...
      <div className="col-md-6 offset-md-1 policies mobile-padding">
        ...
        <p>
          c. <strong>Return of Unwanted Items:</strong> ProCURED accepts returns
          for unwanted items within 3 days of purchase. The product must be
          unused, in its original packaging, and the customer is responsible for
          return shipping costs.
        </p>
        <h5>Cancellation Policy</h5>
        <p>
          a. <strong>Order Cancellation: </strong>Customers can cancel their
          orders within 24 hours of placing the order without incurring any
          cancellation fees. After this timeframe, cancellations may be subject
          to a 10% restocking fee.
        </p>
        <p>
          b. <strong>Subscription Cancellation</strong>: For subscription-based
          services, customers can cancel anytime before the next billing cycle
          to avoid being charged for the upcoming period.
        </p>
        <h5>Refund Process</h5>
        <p>
          a. <strong>Refund Processing Time</strong>: Refunds will be processed
          within 7 business days from the date of approval.
        </p>
        <p>
          {" "}
          b. <strong>Refund Method:</strong> Refunds will be issued through the
          same payment method used for the original purchase.
        </p>
