            ...
            <div className="flexy flexyM">
              ...
              <div className="col-md-11 col-11">
                ...
                <div className="discount-inner">
                  ...
                  <hr />
                  <div className="flexy flexyM">
                    <div className="flexy flexyM mt1 col-md-8 col-9">
                      <p>Code:</p>
                      <button className="code-btn">TCH214JJ</button>
                    </div>
                    <div className="col-md-4 col-3 mt1">
            ...
            <div className="flexy flexyM mt5">
              ...
              <div className="col-md-11 col-11">
                ...
                <div className="discount-inner">
                  ...
                  <hr />
                  <div className="flexy flexyM">
                    <div className="flexy flexyM mt1 col-md-6 col-9">
                      <p>Code:</p>
                      <button className="code-btn">TCH214JJ</button>
                    </div>
                    <div className="col-md-6 col-3 mt1">
                      <button className="app-btn">Collect</button>
                    </div>
                  </div>
                </div>
