          ...
          <div className="nav-tab col-md-10 offset-md-1">
            ...
            <div className="col-md-12 flexy tab ">
              ...
              <div className="col-md-8 subs">
                ...
                >
                  <h5>School</h5>
                  <ul className="list-unstyled row row-cols-3 row-cols-lg-3 g-2 g-lg-3 mt6">
                ...
                >
                  <h5>Construction</h5>
                  <ul className="list-unstyled list-unstyled row row-cols-3 row-cols-lg-3 g-2 g-lg-3 mt6">
