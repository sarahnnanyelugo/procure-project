    ...
    <>
      <footer className="footer-div mobile-padding ">
        <div className="col-md-10 offset-md-1">
          ...
          <hr />
          <div className="flexy">
            <ul className="col-md-8 list-inline list-unstyled areas-list">
            ...
            <ul className=" list-inline list-unstyled areas-list">
              <li className="list-inline-item ">
                <NavLink to={""} target="_blank">
                  className="col-md-8 list-inline list-unstyled areas-list"
                </NavLink>
              </li>
              <li className="list-inline-item ">
