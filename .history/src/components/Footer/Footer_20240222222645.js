    ...
    <>
      <footer className="footer-div mobile-padding ">
        <div className="col-md-10 offset-md-1">
            ...
            <div className="col-md-6 flexy flexyM col-12">
              <div className="col-md-6 col-6">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <NavLink to={"/searched-results"}>Help Center</NavLink>
                  </li>
                  <li>
          ...
          <hr />
          <div className="flexy">
            <ul className="col-md-9 list-inline list-unstyled areas-list">
            ...
            <ul className=" list-inline list-unstyled areas-list2">
              <li className="list-inline-item ">
                <NavLink to={""} target="_blank">
                  Privacy Policy
                </NavLink>
          ...
          <hr />
          <center>
            <p>© 2024 EZY Sourcing || All Right Reserved</p>
          </center>
        </div>
      </footer>
    </>
