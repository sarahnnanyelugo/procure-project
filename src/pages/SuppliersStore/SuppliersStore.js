          ...
          <Accordion.Item eventKey="1">
            ...
            <Accordion.Body>
              <div className="mt5">
                ...
                <p>13-06-2023</p>
                <div className="flexy flexyM">
                  <img src={Star} height="23px" width="23px" />
                  <img src={Star} height="23px" width="23px" />
                  <img src={Star} height="23px" width="23px" />
                  <img src={Star} height="23px" width="23px" />
                  <img src={Star} height="23px" width="23px" />
                ...
                <p>
                  ...
                  delivery. my rep stayed in contact with me every step of the
                  way and I never worried about delivery. the packing was superb
                  and delivery as expected! Will definitely order from this
                  vendor again!
                </p>
              </div>
              <div className="mt5">
